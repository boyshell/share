package org.shell.game.pet.message {
	...
	public dynamic final class PET_MAP extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const MODEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.game.pet.message.PET_MAP.model", "model", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BASE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.game.pet.message.PET_MAP.base", "base", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.game.mobject.message.MOBJECT_OBJECT; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					if (base$count != 0) {
						throw new flash.errors.IOError('Bad data format: PET_MAP.base cannot be set twice.');
					}
					++base$count;
