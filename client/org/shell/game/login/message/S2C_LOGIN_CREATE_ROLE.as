package org.shell.game.login.message {
	...
	public dynamic final class S2C_LOGIN_CREATE_ROLE extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ERROR:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.game.login.message.S2C_LOGIN_CREATE_ROLE.error", "error", (1 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.error.ERROR_CODE);
		 ...
		 *  @private
		 */
		public static const SELF:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.game.login.message.S2C_LOGIN_CREATE_ROLE.self", "self", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.game.role.message.ROLE_SELF; });
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (error$count != 0) {
						throw new flash.errors.IOError('Bad data format: S2C_LOGIN_CREATE_ROLE.error cannot be set twice.');
					}
					++error$count;
				...
				case 2:
					if (self$count != 0) {
						throw new flash.errors.IOError('Bad data format: S2C_LOGIN_CREATE_ROLE.self cannot be set twice.');
					}
					++self$count;
