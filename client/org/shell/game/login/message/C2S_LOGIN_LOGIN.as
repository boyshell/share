package org.shell.game.login.message {
	...
	public dynamic final class C2S_LOGIN_LOGIN extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const USR:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("org.shell.game.login.message.C2S_LOGIN_LOGIN.usr", "usr", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const PLATFORM:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.game.login.message.C2S_LOGIN_LOGIN.platform", "platform", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SERVER:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.game.login.message.C2S_LOGIN_LOGIN.server", "server", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ADULT:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("org.shell.game.login.message.C2S_LOGIN_LOGIN.adult", "adult", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.game.login.message.C2S_LOGIN_LOGIN.time", "time", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SIGN:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("org.shell.game.login.message.C2S_LOGIN_LOGIN.sign", "sign", (6 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (usr$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.usr cannot be set twice.');
					}
					++usr$count;
				...
				case 2:
					if (platform$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.platform cannot be set twice.');
					}
					++platform$count;
				...
				case 3:
					if (server$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.server cannot be set twice.');
					}
					++server$count;
				...
				case 4:
					if (adult$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.adult cannot be set twice.');
					}
					++adult$count;
				...
				case 5:
					if (time$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.time cannot be set twice.');
					}
					++time$count;
				...
				case 6:
					if (sign$count != 0) {
						throw new flash.errors.IOError('Bad data format: C2S_LOGIN_LOGIN.sign cannot be set twice.');
					}
					++sign$count;
