package org.shell.game.config.proto.item {
	...
	public dynamic final class Pitem extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const TYPE:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.game.config.proto.item.Pitem.type", "type", (2 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.game.config.proto.item.Type);
		 ...
		 *  @private
		 */
		public static const POSITION:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("org.shell.game.config.proto.item.Pitem.position", "position", (6 << 3) | com.netease.protobuf.WireType.VARINT, org.shell.game.config.proto.item.Position);
		 ...
		 *  @private
		 */
		public static const LEVEL:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("org.shell.game.config.proto.item.Pitem.level", "level", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BASEATRRIBUTE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.game.config.proto.item.Pitem.baseAtrribute", "baseAtrribute", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.game.config.proto.fight.RandomAttributeList; });
		 ...
		 *  @private
		 */
		public static const APPENDATTRIBUTE:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("org.shell.game.config.proto.item.Pitem.appendAttribute", "appendAttribute", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return org.shell.game.config.proto.fight.RandomAttributeList; });
